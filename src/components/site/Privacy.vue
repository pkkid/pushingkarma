    ...
    <div class='content'>
      <div class='contentbg'>
        <article>
          ...
          <p>Welcome to PushingKarma!</p>
          <p>These terms and conditions outline the rules and regulations for the use of PushingKarma's Website,
            located at https://pushingkarma.com.</p>
          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            PushingKarma if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
            Conditions were created with the help of the <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Terms
            & Conditions Generator Online</a> and the <a href="https://www.termsconditionsgenerator.com">Free Terms &
          ...
          <h3>Cookies</h3>
          <p>We employ the use of cookies. By accessing PushingKarma, you agreed to use cookies in agreement with the
            PushingKarma's Privacy Policy.</p>
          ...
          <h3>License</h3>
          <p>Unless otherwise stated, PushingKarma and/or its licensors own the intellectual property rights for all
            material on PushingKarma. All intellectual property rights are reserved. You may access this from
            PushingKarma for your own personal use subjected to restrictions set in these terms and conditions.</p>
          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. PushingKarma does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of PushingKarma,its agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, PushingKarma shall not be liable for the Comments or for any
          ...
          <p>PushingKarma reserves the right to monitor all Comments and to remove any Comments which can be considered
          ...
          <p>You hereby grant PushingKarma a non-exclusive license to use, reproduce, edit and authorize others to use,
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            absence of PushingKarma; and (d) the link is in the context of general resource information.</p>
          ...
          <p>You may hyperlink to our Website as follows:</p>
          <ul>
          ...
          <p>No use of PushingKarma's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
       ...
       <router-link to='/terms'></router-link>ights</h3>
          ...
          <!-- Privacy Policy -->
          <h1 style='margin-top:60px;'>Privacy Policy for PushingKarma</h1>
          <p>At PushingKarma, accessible from https://pushingkarma.com, one of our main priorities is the privacy of
            our visitors. This Privacy Policy document contains types of information that is collected and recorded by
            PushingKarma and how we use it.</p>
          <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to
            contact us.</p>

          <h3>Log Files</h3>
          <p>PushingKarma follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Like any other website, PushingKarma uses 'cookies'. These cookies are used to store information including
          ...
          <p>For more general information on cookies, please read
            <a href="https://www.privacypolicyonline.com/what-are-cookies/">"What Are Cookies"</a>.</p>

          <h3>Privacy Policies</h3>
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of PushingKarma.
            Our Privacy Policy was created with the help of the <a href="https://www.privacypolicygenerator.org">Free
            Privacy Policy Generator</a> and the <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Privacy
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on PushingKarma, which are sent directly to
          ...
          <p>Note that PushingKarma has no access to or control over these cookies that are used by third-party advertisers.</p>

          <h3>Third Party Privacy Policies</h3>
          <p>PushingKarma's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
          ...
          <p>PushingKarma does not knowingly collect any Personal Identifiable Information from children under the age
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in PushingKarma. This policy is not applicable
