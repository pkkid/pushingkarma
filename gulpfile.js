...
var dist = function(path) { return './pk/static/_dist/'+ path };
...
gulp.task('css', function() {
  return gulp.src('pk/static/css/main.scss')
...
gulp.task('npm', function() {
  return merge(
    //gulp.src('./dashboard/static/img/**/*').pipe(gulp.dest('./dashboard/static/dist/img'));
    //gulp.src('./semantic/dist/**/*').pipe(gulp.dest('./dashboard/static/dist'));
    // core libs
    gulp.src(nm('jquery/dist/*min*')).pipe(gulp.dest(dist('jquery'))),
    gulp.src(nm('jquery-ui-dist/*min*')).pipe(gulp.dest(dist('jquery-ui'))),
    gulp.src(nm('popper.js/dist/*min*')).pipe(gulp.dest(dist('popper.js'))),
    gulp.src(nm('tether/dist/**/*min*')).pipe(gulp.dest(dist('tether'))),
    gulp.src(nm('bootstrap/dist/**/*min*')).pipe(gulp.dest(dist('bootstrap'))),
    // plugins and helpers
    gulp.src(nm('@mdi/font/css/*min*')).pipe(gulp.dest(dist('mdi'))),
...
gulp.task('default', function() {
  gulp.watch(['**/js/*.js', '!**/js/main.js'], gulp.parallel('js'));
