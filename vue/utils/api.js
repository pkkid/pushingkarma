...
export const Budget = {
  ...
  categoryTreemap(params, signal) { return axios.get(`/api/budget/category_treemap`, {params, signal}) },
  monthlySpending(params, signal) { return axios.get(`/api/budget/monthly_spending`, {params, signal}) },
  ...
  listRecurring(params, signal) { return axios.get(`/api/budget/recurring`, {params, signal}) },
  categorizeSimilarTransaction(pk, signal) { return axios.post(`/api/budget/transactions/${pk}/categorize_similar`, null, {signal}) },
