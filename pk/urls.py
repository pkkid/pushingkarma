...
# Read only views
api.add_url(url(r'^events', tools_api.events, name='events'))
api.add_url(url(r'^news', tools_api.news, name='news'))
api.add_url(url(r'^photo', tools_api.photo, name='photo'))
api.add_url(url(r'^tasks', tools_api.tasks, name='tasks'))
api.add_url(url(r'^weather', tools_api.weather, name='weather'))
